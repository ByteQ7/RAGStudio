...
public class SiliconFlowChatClient implements ChatClient {
    ...
    public SiliconFlowChatClient(HttpModelFactory modelFactory, ModelHttpClient httpClient,
    ...
    @Override public String provider() { return ModelProvider.SILICON_FLOW.getId(); }
