 ...
 * - 采用接口隔离模式：每个实现类（BaiLianChatClient、SiliconFlowChatClient 等）基于 OkHttp 实现
...
public interface ChatClient {
     ...
     * <p>
     * 实现说明：
     * - 由 OkHttp + HTTP POST 实现，各 Client 负责请求体构建
     ...
     * <p>
     * 实现说明：
     * - 由 OkHttp + SSE 解析实现流式能力，
     *   通过 ModelHttpClient 的 SSE 解析桥接到 StreamCallback
