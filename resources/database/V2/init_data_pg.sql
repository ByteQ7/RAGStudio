...
(1831730000000000203, 1821730000000000102, 'Pro/zai-org/GLM-4.7',      'GLM-4.7',                        'CHAT', 0, 3,  1, 1, 1, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
...
-- Embedding 模型
(1831730000000000205, 1821730000000000102, 'Qwen/Qwen3-Embedding-8B', 'Qwen3-Embedding-8B',          'EMBEDDING', 1, 1,  1, 0, 0, '[1024,1536,4096]', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
-- Rerank 模型
...
(1821730000000000107, 'openai',       'OpenAI',              'https://api.openai.com',            NULL, '{"chat":"/v1/chat/completions","embedding":"/v1/embeddings","models":"/v1/models"}'::jsonb, 1, 's3://ragstudio/provider-icons/openai.svg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1821730000000000108, 'openrouter',   'OpenRouter',          'https://openrouter.ai/api',         NULL, '{"chat":"/v1/chat/completions","models":"/v1/models"}'::jsonb, 1, 's3://ragstudio/provider-icons/openrouter.svg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1821730000000000109, 'moonshot',     '月之暗面 (Kimi)',      'https://api.moonshot.cn',           NULL, '{"chat":"/v1/chat/completions","models":"/v1/models"}'::jsonb, 1, 's3://ragstudio/provider-icons/moonshot.svg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1821730000000000110, 'minimax',      'MiniMax (海螺AI)',     'https://api.minimaxi.com',          NULL, '{"chat":"/v1/chat/completions","embedding":"/v1/embeddings","models":"/v1/models"}'::jsonb, 1, 's3://ragstudio/provider-icons/minimax.svg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1821730000000000111, 'zeroone',      '零一万物 (Yi)',         'https://api.lingyiwanwu.com',       NULL, '{"chat":"/v1/chat/completions","models":"/v1/models"}'::jsonb, 1, 's3://ragstudio/provider-icons/zeroone.svg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1821730000000000112, 'baidu',        '百度千帆 (ERNIE)',      'https://qianfan.baidubce.com',       NULL, '{"chat":"/v2/chat/completions","embedding":"/v2/embeddings","models":"/v2/models"}'::jsonb, 1, 's3://ragstudio/provider-icons/baidu.svg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1821730000000000113, 'tencent',      '腾讯混元',              'https://api.hunyuan.cloud.tencent.com', NULL, '{"chat":"/v1/chat/completions","models":"/v1/models"}'::jsonb, 1, 's3://ragstudio/provider-icons/tencent.svg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1821730000000000114, 'together',     'Together AI',          'https://api.together.xyz',          NULL, '{"chat":"/v1/chat/completions","models":"/v1/models"}'::jsonb, 1, 's3://ragstudio/provider-icons/together.svg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1821730000000000115, 'groq',         'Groq',                 'https://api.groq.com',             NULL, '{"chat":"/v1/chat/completions","models":"/v1/models"}'::jsonb, 1, 's3://ragstudio/provider-icons/groq.svg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1821730000000000116, 'mistral',      'Mistral AI',           'https://api.mistral.ai',           NULL, '{"chat":"/v1/chat/completions","models":"/v1/models"}'::jsonb, 1, 's3://ragstudio/provider-icons/mistral.svg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1821730000000000117, 'stepfun',      '阶跃星辰 (StepFun)',    'https://api.stepfun.com',           NULL, '{"chat":"/v1/chat/completions","models":"/v1/models"}'::jsonb, 1, 's3://ragstudio/provider-icons/stepfun.svg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1821730000000000118, 'sensetime',    '商汤 (日日新)',          'https://api.sensetime.com',         NULL, '{"chat":"/v1/chat/completions","models":"/v1/models"}'::jsonb, 1, 's3://ragstudio/provider-icons/sensetime.svg', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0)
ON CONFLICT (id) DO NOTHING;
...
(1831730000000000211, 1821730000000000107, 'text-embedding-3-small', 'text-embedding-3-small', 'EMBEDDING', 0, 1, 1, 0, 0, '[1536]', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
