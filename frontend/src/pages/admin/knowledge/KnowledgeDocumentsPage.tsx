...
const statusDotClass = (status?: string | null) => {
  ...
  if (normalized === "success") return "bg-blue-500";
  if (normalized === "failed") return "bg-red-500";
  if (normalized === "running") return "bg-amber-500";
  if (normalized === "pending") return "bg-gray-400";
                      ...
                      <div>
                        ...
                        <div className="flex h-9 items-center">
                          <button
                            ...
                            className={cn(
                              "relative inline-flex h-5 w-9 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background",
                              detailNoChunk ? "bg-blue-600" : "bg-gray-200"
                            )}
                          >
                            <span
                              className={cn(
              ...
              {logData.records.slice(0, 1).map((log) => {
                ...
                <div key={log.id} className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <span className={cn(
                        ...
                        log.status === "success" ? "bg-blue-50 text-blue-700" :
                  ...
                  <div className="flex items-center gap-2 text-sm text-gray-500">
                    <span>执行时间</span>
                    <span className="tabular-nums text-gray-700">{formatDate(log.startTime)}</span>
                    <span>~</span>
                    <span className="tabular-nums text-gray-700">{log.endTime ? formatDate(log.endTime) : "进行中"}</span>
                  </div>
                      ...
                      <FormControl>
                        <div className="flex h-9 items-center">
                          <button
                            ...
                            className={cn(
                              "relative inline-flex h-5 w-9 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background",
                              noChunk ? "bg-blue-600" : "bg-gray-200"
                            )}
                          >
                            <span
                              className={cn(
