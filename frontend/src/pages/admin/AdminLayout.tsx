      ...
      <aside className={cn("admin-sidebar", collapsed && "admin-sidebar--collapsed")}>
        <div className="admin-sidebar__brand">
          <div className={cn("flex items-center gap-3", collapsed && "justify-center")}>
            <div className="admin-sidebar__logo"><RAGStudioLogo className="h-7 w-7" /></div>
            {!collapsed && (
              <div className="min-w-0">
                <h1 className="admin-sidebar__title">RAGStudio 管理后台</h1>
                      ...
                      return (
                        <div key={item.label} className="space-y-1">
                          <button
                            ...
                            className={cn(
                              "admin-sidebar__item admin-sidebar__item--group w-full text-gray-400",
                              isGroupActive && "admin-sidebar__item--group-active text-gray-900"
                            )}
                          >
                            <span
                              className={cn(
