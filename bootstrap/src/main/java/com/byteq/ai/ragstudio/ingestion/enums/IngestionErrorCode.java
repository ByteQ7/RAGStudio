package com.byteq.ai.ragstudio.ingestion.enums;
 ...
 * 文档摄入管线域错误码
 *
 * <p>码段分配：{@code A007xxx}（客户端）/ {@code B007xxx}（服务端）/ {@code C007xxx}（远程），
 ...
 */
public enum IngestionErrorCode implements IErrorCode {

    PIPELINE_NOT_FOUND("A007001", "未找到流水线"),

    FILE_TOO_LARGE("B007001", "文件大小超过限制"),

    NETWORK_REQUEST_FAILED("B007002", "网络请求失败"),

    FETCH_FAILED("C007001", "文件获取失败");

    private final String code;

    private final String message;

    IngestionErrorCode(String code, String message) {
        this.code = code;
